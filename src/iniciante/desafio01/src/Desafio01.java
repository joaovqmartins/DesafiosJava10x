package iniciante.desafio01.src;
    ...
    public static void main(String[] args) {
        ...
        if (idadeNinja1 < 15) {
           if (rankMissaoNinja1 == 'C' || rankMissaoNinja1 == 'D') {
               missaoStatus1 = "Missão pode ser concluida!";
               System.out.println(missaoStatus1);
           } else {
               missaoStatus1 = "Missão não pode ser concluida!";
               System.out.println(missaoStatus1);
           }
        } else {
            missaoStatus1 = "Missão pode concluida!";
            System.out.println(missaoStatus1);
        }
        ...
        if (idadeNinja2 < 15) {
            if (rankMissaoNinja2 == 'C' || rankMissaoNinja2 == 'D') {
                missaoStatus2 = "Missão pode ser concluida!";
                System.out.println(missaoStatus2);
            } else {
                missaoStatus2 = "Missão não pode ser concluida!";
                System.out.println(missaoStatus2);
            }
        } else {
            missaoStatus2 = "Missão pode ser concluida!";
        ...
        if (idadeNinja3 < 15) {
            if (rankMissaoNinja3 == 'C' || rankMissaoNinja3 == 'D') {
                missaoStatus3 = "Missão pode ser concluida!";
                System.out.println(missaoStatus3);
            } else {
                missaoStatus3 = "Missão não pode ser concluida!";
                System.out.println(missaoStatus3);
            }
        }else {
            missaoStatus3 = "Missão pode ser concluida!";
